...
import { Heart, Scale, Ruler, User, RefreshCw, Activity, Info, TrendingUp, TrendingDown, Minus, Flame, Target, History, Share2, Copy, Check, Trash2, Zap, Download, FileText } from 'lucide-react'
...
const translations = {
  ar: {
    ...
    bmiValue: 'قيمة مؤشر كتلة الجسم',
    bmiCategory: 'تصنيف مؤشر كتلة الجسم',
    recommendations: 'التوصيات الصحية',
                  ...
                  <Card className="shadow-xl shadow-slate-200/50 dark:shadow-slate-800/50 border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="space-y-3 pt-4 border-t border-slate-200 dark:border-slate-700">
                        ...
                        <div className="space-y-3">
                          <div>
                            <Label htmlFor="fullName" className="text-slate-700 dark:text-slate-300 font-medium text-sm mb-2">
                              {t.name}
                            </Label>
                            <Input
                              id="fullName"
                              ...
                              className="w-full h-10 border-slate-200 dark:border-slate-700 focus:border-emerald-500"
                            />
                          </div>

                          <div>
                            <Label htmlFor="jobTitle" className="text-slate-700 dark:text-slate-300 font-medium text-sm mb-2">
                              {t.jobTitle}
                            </Label>
                            <Input
                              id="jobTitle"
                          ...
                          <div>
                            <Label htmlFor="reportTitle" className="text-slate-700 dark:text-slate-300 font-medium text-sm mb-2">
                              {t.reportTitle}
                            </Label>
                            <Input
                              id="reportTitle"
                              type="text"
                              placeholder={language === 'ar' ? 'مثال: تقرير صحة شهري' : 'e.g., Monthly Health Report'}
                              value={reportTitle}
                  ...
                  <Card className={`shadow-xl border-2 ${result.borderColor} bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm`}>
                    <CardHeader className="text-center pb-4 flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button variant="ghost" size="sm" onClick={generatePDF} className="hover:bg-emerald-50 dark:hover:bg-emerald-950/30">
